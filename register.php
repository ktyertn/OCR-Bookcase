        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="inc/insert.php">
                ...
                <input type="submit" href="register.php" class="btn btn-primary btn-user btn-block" name="submit" value="Submit">
                  Register Account
</input>
                <hr>               
              </form>
